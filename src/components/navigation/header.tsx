      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden md:flex gap-6">
            <Link to="/" className={`flex items-center gap-2 text-sm font-extrabold tracking-widest uppercase font-sans hover:text-creative-500 transition-colors ${theme === "light" ? "text-gray-800" : "text-white"}`}>
              <Home className="w-5 h-5 text-creative-500" /> HOME
            </Link>
            <Link to="/library" className={`flex items-center gap-2 text-sm font-extrabold tracking-widest uppercase font-sans hover:text-creative-500 transition-colors ${theme === "light" ? "text-gray-800" : "text-white"}`}>
              <User className="w-5 h-5 text-creative-500" /> MY VIDEOS
            </Link>
            <Link to="/workspace" className={`flex items-center gap-2 text-sm font-extrabold tracking-widest uppercase font-sans hover:text-creative-500 transition-colors ${theme === "light" ? "text-gray-800" : "text-white"}`}>
              <FolderOpen className="w-5 h-5 text-creative-500" /> WORKSPACE
            </Link>
            <Link to="/share" className={`flex items-center gap-2 text-sm font-extrabold tracking-widest uppercase font-sans hover:text-creative-500 transition-colors ${theme === "light" ? "text-gray-800" : "text-white"}`}>
              <Share2 className="w-5 h-5 text-creative-500" /> SHARE
            </Link>
            <Link to="/analytics" className={`flex items-center gap-2 text-sm font-extrabold tracking-widest uppercase font-sans hover:text-creative-500 transition-colors ${theme === "light" ? "text-gray-800" : "text-white"}`}>
